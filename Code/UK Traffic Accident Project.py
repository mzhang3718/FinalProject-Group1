...
# Xinning Wang   Email:xinningwang1031@gwu.edu
# Yilin Wang     Email:wylpp@gwu.edu
# %%%%%%%%%%%%% Date:
# August - 11 - 2018
...
X_data = pd.get_dummies(df.iloc[:, 1:], drop_first=True)
X = X_data.values
...
clf_mlp = MLPClassifier(**MLP_parameters)
